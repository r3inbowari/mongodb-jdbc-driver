...
import com.dbschema.debug.FTQQDebugConnector;
...
public class MongoDatabaseMetaData implements DatabaseMetaData
{
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        MongoConnection mongoConnection = (MongoConnection) con;
        MongoDatabaseMetaData a = new MongoDatabaseMetaData(mongoConnection);
        ResultSet rs = a.getColumns("farmland", null, "LoginUser", "%");
        ResultSetMetaData metaData = rs.getMetaData();
        for (int i = 1; i <= metaData.getColumnCount(); i++) {
            String ab = metaData.getColumnLabel(i);
            String aa = metaData.getColumnTypeName(i);
    ...
    public ResultSet getColumns(String catalogName, String schemaName, String tableNamePattern, String columnNamePattern) {
        // FTQQDebugConnector.DebugMsg("getColumns", catalogName+"@"+schemaName+"@"+tableNamePattern+"@"+columnNamePattern+"@");
        ...
        if ( collection != null ){
            for ( MetaField field : collection.fields){
                if ( columnNamePattern == null || columnNamePattern.equals("%") || columnNamePattern.equals( field.name )){
